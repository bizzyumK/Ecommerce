                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div className="space-y-6">
                                ...
                                <div className="flex flex-wrap gap-4 pt-4">
                                    <button className="bg-teal-600 text-white px-8 py-3 cursor-pointer rounded-lg font-semibold hover:bg-teal-800 transition-all transform hover:scale-105 shadow-lg">
                                        Shop Now
                                    </button>
